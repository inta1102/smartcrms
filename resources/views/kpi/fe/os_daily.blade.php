...
<script>
  ...
  const metricPalette = {
    ...
    os_dpk:         { border: '#b91c1c', fill: 'rgba(185,28,28,0.20)' },
    os_potensi:     { border: '#ea580c', fill: 'rgba(234,88,12,0.20)' },
    os_kl:          { border: '#7c2d12', fill: 'rgba(124,45,18,0.20)' },

    rr:             { border: '#16a34a', fill: 'rgba(22,163,74,0.55)' },
    pct_lt:         { border: '#9333ea', fill: 'rgba(147,51,234,0.55)' },
    pct_dpk:        { border: '#dc2626', fill: 'rgba(220,38,38,0.55)' },
    pct_potensi:    { border: '#f97316', fill: 'rgba(249,115,22,0.55)' },
    pct_kl:         { border: '#92400e', fill: 'rgba(146,64,14,0.55)' },
  };
