...
<div class="mx-auto max-w-6xl px-4 py-6">
    ...
    <div class="mt-5 rounded-2xl border border-slate-100 bg-white p-4 shadow-sm">
        <form method="GET" class="grid grid-cols-1 gap-3 lg:grid-cols-4 lg:items-end">
            {{-- Keyword --}}
            <div class="lg:col-span-2">
                <label class="text-xs font-semibold text-slate-600">Cari Nama / SHM / No Pengajuan</label>
                <input
                    type="text"
                    name="q"
                    value="{{ $q }}"
                    placeholder="Contoh: Budi, SHM 123, atau nomor pengajuan..."
                    class="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 placeholder:text-slate-400 focus:border-slate-400 focus:outline-none"
                >
                <div class="mt-1 text-[11px] text-slate-500">
                    Pencarian fleksibel berdasarkan nama debitur, nomor SHM, atau nomor pengajuan.
                </div>
            </div>
            ...
            <div class="flex gap-2">
                <button type="submit"
                        class="w-1/2 sm:w-auto rounded-xl border border-slate-200 bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800">
                    Terapkan
                </button>
